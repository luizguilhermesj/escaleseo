module.exports = function (shipit) {
  ...
  shipit.initConfig({
    default: {
      workspace: '/tmp/escaleseo',
      deployTo: '/root/escaleseo',
      repositoryUrl: 'git@github.com:luizguilhermesj/escaleseo.git',
      ignores: ['.git'],
      rsync: ['--del'],
      keepReleases: 4
    },
  ...
  shipit.task('restart',['npm'], function(){
    ...
    shipit.remote('PORT=8080 forever start '+shipit.currentPath+'/bin/www');
